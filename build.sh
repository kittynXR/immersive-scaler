...
# Build script for cátte — Immersive Scaler
...
# Configuration
PACKAGE_NAME="cat.kittyn.immersive-scaler"
ROOT_DIR="cat.kittyn.immersive-scaler"
REPO_OWNER="kittynXR"
REPO_NAME="immersive-scaler"
...
3. Find \"cátte — Immersive Scaler\" in the package list and click \"Add\"
"
...
gh release create "$TAG" \
    --title "cátte — Immersive Scaler $NEW_VERSION" \
    --notes "$RELEASE_NOTES" \
    $RELEASE_FILES
